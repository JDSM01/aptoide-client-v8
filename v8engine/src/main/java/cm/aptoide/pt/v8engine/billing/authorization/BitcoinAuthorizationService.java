...
public class BitcoinAuthorizationService implements AuthorizationService { //maybe for tokens
    ...
    public BitcoinAuthorizationService(AuthorizationFactory authorizationFactory,
    ...
    @Override
    public Single<Authorization> createAuthorization(String payerId, int paymentId) {
    ...
    @Override
    public Single<List<Authorization>> getAuthorizations(String payerId, int paymentId) {
